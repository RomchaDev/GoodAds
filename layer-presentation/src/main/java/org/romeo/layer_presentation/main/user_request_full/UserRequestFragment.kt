...
class UserRequestFragment :
    BaseFragment<FragmentRequestUserBinding, AdvertisingRequestFull, UserRequestViewModel>(R.layout.fragment_request_user) {
    ...
    override fun renderSuccess(data: AdvertisingRequestFull) {
