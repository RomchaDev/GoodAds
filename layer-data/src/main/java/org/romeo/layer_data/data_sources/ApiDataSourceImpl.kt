...
class ApiDataSourceImpl(
    ...
    override fun advertiseOtherAd(id: String): Deferred<Unit> =
        service.advertiseOtherAd(id)
    ...
    override fun getMyUserRequest(userId: String): Deferred<AdUser> =
        service.getMyUserRequest(userId)
}